    ...
    <div className="card">
      ...
      <div className="card__publication-info">
        <div className="rating__container">
          <svg className="rating__logo" fill="var(--color-grey)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div className="author__container">
          <svg className="author__logo" fill="var(--color-grey)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <p className="author__text">{author}</p>
        </div>
      </div>
      <p className="card__publication-date">{date}</p>
    </div>
